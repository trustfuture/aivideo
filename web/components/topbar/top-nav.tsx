  ...
  return (
    <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 pb-3">
      <nav className="flex items-center gap-4 text-sm text-muted-foreground md:hidden">
        ...
        <Link href="/edit/video/tasks" className="hover:text-foreground">{t('nav.tasks')}</Link>
        <Link href="/edit/video/create" className="hover:text-foreground">{t('nav.create')}</Link>
