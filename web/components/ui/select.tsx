...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-[var(--control-h)] w-full items-center justify-between rounded-md border border-input bg-background px-[var(--control-px)] py-[var(--control-py)] text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 transition-all',
      className
    )}
    {...props}
  >
